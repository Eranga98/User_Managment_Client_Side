	...
	<br>
				...
				<form id="formUpdateBtn">
					<input type="hidden" class="form-control" name="txtEmail"
						id="txtEmail"
						value="<%out.print(session.getAttribute("Email"));%>"> <input
						id="btnUpdateReq" name="btnUpdateReq" type='button' value='Update'
				...
				<form>
					<input class="form-control" name="dltAcc" id="dltAcc"
						data-id='" <%out.print(session.getAttribute("Id"));%> "' value="">
